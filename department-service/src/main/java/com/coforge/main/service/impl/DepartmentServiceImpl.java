...
import com.coforge.main.kafka.DepartmentProducer;
...
//		return savedDepartmentDto;
	...
	public DepartmentDto getDepartmentByCode(String departmentCode) {
		...
		log.info("Executing getDepartmentByCode...");
	...
	public ApiResponseDto getDepartmentDetailsbyCode (UserDetailsEvent userDetailsEvent) {
		log.info("User Details event received in department-service -> {}", userDetailsEvent);
		
		DepartmentDto departmentDto = getDepartmentByCode(userDetailsEvent.getDepartmentCode());
		ApiResponseDto apiResponseDto = new ApiResponseDto(userDetailsEvent, departmentDto);
		departmentProducer.sendDepartmentDetails(apiResponseDto);
