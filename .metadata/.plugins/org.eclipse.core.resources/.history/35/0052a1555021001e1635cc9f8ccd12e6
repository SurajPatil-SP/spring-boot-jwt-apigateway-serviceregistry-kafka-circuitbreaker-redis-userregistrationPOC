...
//		return new ResponseEntity ("Bad Request", HttpStatus.BAD_REQUEST);
	...
	public ResponseEntity<String> getUserandDepartmentDetails (@PathVariable("userId") Long userId) {
		log.info("Executing getUserandDepartmentDetails...");
		String response = userRegistrationService.userWithDepartmentDetails(userId);
		return new ResponseEntity<> (response, HttpStatus.OK);
	}
	
    @GetMapping("/retrieve/{userId}")
    public ResponseEntity<ApiResponseDto> getUserById(@PathVariable("userId") Long userId){
    	log.info("Executing getUserandDepartmentDetails...");
    	ApiResponseDto apiResponseDto = userRegistrationService.retrieveUserDetailsById(userId);
